...
class ContractorMessagePage extends StatelessWidget {
  const ContractorMessagePage({super.key});
  ...
  Future<Map<String, dynamic>?> _fetchUserData(String receiverType, String id) async {
    ...
    // 🔍 Try each collection if receiverType is inconsistent
                ...
                builder: (context, userSnapshot) {
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        debugPrint("🟢 Opening chat with $name ($otherId)");
